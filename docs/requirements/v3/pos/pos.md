...
- Entry points: Menu **POS**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P1
- Wave: 2
- Menu ID: 342

## 2. Purpose
Point-of-sale billing / counter management. Fast item entry, customer select, tender, and save into sales documents. Counters track till open/close. See POS register requirements for billing rules aligned with sales posting.
...
- Entities involved: Counter, CounterTrans, Sale, SaleLine, BillType
...
- Given a user with menu access, they can open **POS** and see tenant-scoped data
