...
- Entry points: Menu **Status Master**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Status Master** and see tenant-scoped data
...
- Old URL: `crm_general/Enquiry_followup/listStatus`
