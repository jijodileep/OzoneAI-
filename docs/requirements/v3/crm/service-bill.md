...
- Entry points: Menu **Service Bill**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Service Bill** and see tenant-scoped data
...
- Old URL: `crm_service/Enquiry_list/listall`
