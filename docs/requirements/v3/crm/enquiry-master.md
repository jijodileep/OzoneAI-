...
- Entry points: Menu **Enquiry Master**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Enquiry Master** and see tenant-scoped data
...
- Old URL: `crm_new/Enquiry_allocation/list_all`
