...
- Entry points: Menu **Import**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Import** and see tenant-scoped data
...
- Old URL: `crm_general/Excel_import/excel`
