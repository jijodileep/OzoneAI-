...
- Entry points: Menu **Service Call Register**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Service Call Register** and see tenant-scoped data
...
- Old URL: `crm_service/Enquiry_allocation/list_all`
