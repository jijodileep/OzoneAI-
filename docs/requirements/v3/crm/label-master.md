...
- Entry points: Menu **Label Master**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Label Master** and see tenant-scoped data
...
- Old URL: `crm_new/Enquiry_followup/listLabel`
