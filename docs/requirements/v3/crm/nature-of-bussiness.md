...
- Entry points: Menu **Nature of Bussiness**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P1
- Wave: 2
- Menu ID: 334

## 2. Purpose
CRM screen in the enquiry lifecycle: Lead → Enquiry → Allocation → Follow-up → Closure/Bill. Track source, products, salesperson, status, and history. Reports are filterable aggregations of the same entities.
...
- Entities involved: Lead, Enquiry, EnquiryAllocation, EnquiryFollowup, EnquiryProduct, StatusMaster, SourceEnquiry
...
- Given a user with menu access, they can open **Nature of Bussiness** and see tenant-scoped data
...
- Old URL: `crm_general/Enquiry_allocation/listOtherofBuss`
