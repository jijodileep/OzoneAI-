...
- Entry points: Menu **Allocated Services**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Allocated Services** and see tenant-scoped data
...
- Old URL: `crm_service/Enquiry_register/list_all`
