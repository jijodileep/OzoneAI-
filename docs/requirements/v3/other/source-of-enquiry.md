...
- Entry points: Menu **Source Of Enquiry**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P0
- Wave: 1
- Menu ID: 388

## 2. Purpose
Application page from v3 menu inventory. Implement as authenticated tenant-scoped screen with role permissions.
...
- Entities involved: Tenant-scoped domain entities for this screen
...
- Given a user with menu access, they can open **Source Of Enquiry** and see tenant-scoped data
...
- Old URL: `source_of_enquiry/Source_of_enquiry/list_all`
