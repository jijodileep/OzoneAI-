...
- Entry points: Menu **Members**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Members** and see tenant-scoped data
