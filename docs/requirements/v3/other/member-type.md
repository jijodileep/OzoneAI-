...
- Entry points: Menu **Member Type**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Member Type** and see tenant-scoped data
