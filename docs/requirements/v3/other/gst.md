...
- Entry points: Menu **GST**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **GST** and see tenant-scoped data
