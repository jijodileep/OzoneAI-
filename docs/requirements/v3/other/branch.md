...
- Entry points: Menu **Branch**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Branch** and see tenant-scoped data
...
- Old URL: `Masters/company_branch`
