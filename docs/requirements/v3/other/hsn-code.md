...
- Entry points: Menu **Hsn Code**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Hsn Code** and see tenant-scoped data
