...
- Entry points: Menu **Tags**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Tags** and see tenant-scoped data
