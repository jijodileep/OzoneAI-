...
- Entry points: Menu **Merge**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Merge** and see tenant-scoped data
