...
- Entry points: Menu **Cess**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Cess** and see tenant-scoped data
