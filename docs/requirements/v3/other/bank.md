...
- Entry points: Menu **Bank**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Bank** and see tenant-scoped data
