...
- Entry points: Menu **Item Tags**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Item Tags** and see tenant-scoped data
