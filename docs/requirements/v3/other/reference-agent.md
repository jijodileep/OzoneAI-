...
- Entry points: Menu **Reference (Agent)**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Reference (Agent)** and see tenant-scoped data
