...
- Entry points: Menu **Point Settings**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Point Settings** and see tenant-scoped data
