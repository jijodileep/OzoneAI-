...
- Entry points: Menu **Member Category**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Member Category** and see tenant-scoped data
...
- Old URL: `masters/member_category`
