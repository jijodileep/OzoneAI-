...
- Entry points: Menu **Batches**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Batches** and see tenant-scoped data
...
- Old URL: `education/Student/batch`
