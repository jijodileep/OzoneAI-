...
- Entry points: Menu **Document Master**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P2
- Wave: 3
- Menu ID: 386

## 2. Purpose
Education vertical: courses, students, batches, fees, documents, attendance/schedules. Fees may post to ledgers/vouchers. Course may be modeled as an item with fee components.
...
- Entities involved: Student, Course, FeeStructure, Attendance, Schedule
...
- Given a user with menu access, they can open **Document Master** and see tenant-scoped data
...
- Old URL: `education/Student/listDoc`
