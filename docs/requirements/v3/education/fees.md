...
- Entry points: Menu **Fees**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Fees** and see tenant-scoped data
...
- Old URL: `education/Student/feeStructure`
