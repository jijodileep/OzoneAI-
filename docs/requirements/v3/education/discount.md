...
- Entry points: Menu **Discount**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Discount** and see tenant-scoped data
...
- Old URL: `education/Course/listDiscount`
