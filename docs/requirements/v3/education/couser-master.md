...
- Entry points: Menu **Couser Master**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Couser Master** and see tenant-scoped data
...
- Old URL: `education/Course/listall`
