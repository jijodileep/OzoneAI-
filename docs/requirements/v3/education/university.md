...
- Entry points: Menu **University**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **University** and see tenant-scoped data
...
- Old URL: `education/Course/university`
