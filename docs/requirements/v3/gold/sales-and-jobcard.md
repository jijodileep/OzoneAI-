...
- Entry points: Menu **Sales And Jobcard**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P2
- Wave: 3
- Menu ID: 462

## 2. Purpose
Jewellery/gold vertical: melting, production, design job cards, sales+jobcard. Tracks customer jobs and material consumption; may generate bills.
...
- Entities involved: GoldMelting, GoldProduction, GoldDesign, SalesAndJobcard
...
- Given a user with menu access, they can open **Sales And Jobcard** and see tenant-scoped data
...
- Old URL: `gold/SalesJob/list_all`
