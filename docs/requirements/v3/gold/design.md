...
- Entry points: Menu **Design**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Design** and see tenant-scoped data
