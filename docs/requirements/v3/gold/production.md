...
- Entry points: Menu **Production**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Production** and see tenant-scoped data
...
- Old URL: `gold/Production/list_all`
