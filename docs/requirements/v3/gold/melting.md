...
- Entry points: Menu **MELTING**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **MELTING** and see tenant-scoped data
