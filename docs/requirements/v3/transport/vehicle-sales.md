...
- Entry points: Menu **Vehicle Sales**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Vehicle Sales** and see tenant-scoped data
...
- Old URL: `sales_vehicle/Sales_vehicle/listall`
