...
- Entry points: Menu **Manufactur**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Manufactur** and see tenant-scoped data
...
- Old URL: `Vehicle_masters/vehicle_manufacture`
