...
- Entry points: Menu **Insurance Company**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P2
- Wave: 3
- Menu ID: 262

## 2. Purpose
Transport/vehicle vertical: vehicle masters, insurance, drivers, trips/orders, freight transactions. Links vehicles to customers/owners.
...
- Entities involved: Vehicle, VehicleDetails, Trip/Order, Manufacture
...
- Given a user with menu access, they can open **Insurance Company** and see tenant-scoped data
...
- Old URL: `Vehicle_masters/vehicle_insurance_company`
