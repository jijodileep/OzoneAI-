...
- Entry points: Menu **Insurance**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Insurance** and see tenant-scoped data
...
- Old URL: `Vehicle_masters/vehicle_insurance`
