...
- Entry points: Menu **Visa Types**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Visa Types** and see tenant-scoped data
...
- Old URL: `Vehicle_masters/visa_type`
