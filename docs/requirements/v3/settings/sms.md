...
- Entry points: Menu **SMS**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **SMS** and see tenant-scoped data
...
- Old URL: `settings/message/listall`
