...
- Entry points: Menu **Set Device**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Set Device** and see tenant-scoped data
...
- Old URL: `settings/set_device/device`
