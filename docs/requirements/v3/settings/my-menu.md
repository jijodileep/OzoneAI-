...
- Entry points: Menu **My Menu**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **My Menu** and see tenant-scoped data
...
- Old URL: `settings/menus/user_menu`
