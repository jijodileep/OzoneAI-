...
- Entry points: Menu **Pay Settings**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Pay Settings** and see tenant-scoped data
...
- Old URL: `hr/paysettings/list_all`
