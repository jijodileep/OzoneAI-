...
- Entry points: Menu **Software Version**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Software Version** and see tenant-scoped data
...
- Old URL: `settings/SoftwareVersion/listall`
