...
- Entry points: Menu **Bill Format**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Bill Format** and see tenant-scoped data
