...
- Entry points: Menu **SMS Types**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **SMS Types** and see tenant-scoped data
...
- Old URL: `settings/sms/sms_types`
