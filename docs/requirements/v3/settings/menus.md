...
- Entry points: Menu **Menus**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Menus** and see tenant-scoped data
