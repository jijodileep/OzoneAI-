...
- Entry points: Menu **SMS Settings**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **SMS Settings** and see tenant-scoped data
...
- Old URL: `settings/sms/sms_settings`
