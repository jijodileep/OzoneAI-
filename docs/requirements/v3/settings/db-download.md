...
- Entry points: Menu **Db Download**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Db Download** and see tenant-scoped data
...
- Old URL: `settings/setting/db_download`
