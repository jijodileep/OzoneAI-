...
- Entry points: Menu **Slider**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Slider** and see tenant-scoped data
...
- Old URL: `settings/sliders/listall`
