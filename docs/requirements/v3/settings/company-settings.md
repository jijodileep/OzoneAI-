...
- Entry points: Menu **Company Settings**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P0
- Wave: 1
- Menu ID: 95

## 2. Purpose
Configuration / administration screen (company, users, menus, SMS, devices, bill formats, software version, DB tools). Changes affect tenant-wide behavior. Protect behind Admin/Super Admin.
...
- Entities involved: Company, CompanySettings, User, Menu, MenuToUser, SmsSettings, BillType, Device
...
- Given a user with menu access, they can open **Company Settings** and see tenant-scoped data
...
- Old URL: `settings/CompanySettings/listall`
