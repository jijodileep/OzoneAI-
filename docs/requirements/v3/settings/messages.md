...
- Entry points: Menu **Messages**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Messages** and see tenant-scoped data
