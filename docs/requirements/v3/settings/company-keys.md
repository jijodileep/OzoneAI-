...
- Entry points: Menu **Company Keys**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Company Keys** and see tenant-scoped data
...
- Old URL: `settings/CompanySettings/company_keys`
