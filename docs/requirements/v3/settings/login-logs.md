...
- Entry points: Menu **Login Logs**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Login Logs** and see tenant-scoped data
...
- Old URL: `settings/loginsett/listall`
