...
- Entry points: Menu **Material In**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Material In** and see tenant-scoped data
