...
- Entry points: Menu **Job Card In**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Job Card In** and see tenant-scoped data
