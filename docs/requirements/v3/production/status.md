...
- Entry points: Menu **Status**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Status** and see tenant-scoped data
...
- Old URL: `production/status/Status_controller/listall`
