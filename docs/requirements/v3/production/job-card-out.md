...
- Entry points: Menu **Job Card Out**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Job Card Out** and see tenant-scoped data
