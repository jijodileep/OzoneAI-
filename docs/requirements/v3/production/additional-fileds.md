...
- Entry points: Menu **Additional Fileds**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P2
- Wave: 3
- Menu ID: 374

## 2. Purpose
Production vertical: BOM, process runs, stages/status, labels, job cards, material in/out. Consumes raw materials and produces finished items with optional ledger cost allocation.
...
- Entities involved: Bom, ProductionProcess, ProductionStage, ProductionStatus, JobCard, Material
...
- Given a user with menu access, they can open **Additional Fileds** and see tenant-scoped data
...
- Old URL: `production/label/label_controller/listall`
