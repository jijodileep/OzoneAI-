...
- Entry points: Menu **BoM List**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **BoM List** and see tenant-scoped data
...
- Old URL: `production/bom/bom_controller/listall`
