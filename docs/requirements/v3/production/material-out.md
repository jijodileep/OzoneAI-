...
- Entry points: Menu **Material Out**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Material Out** and see tenant-scoped data
