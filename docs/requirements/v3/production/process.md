...
- Entry points: Menu **Process**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Process** and see tenant-scoped data
...
- Old URL: `production/process/process_controller/listall`
