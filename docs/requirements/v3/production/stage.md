...
- Entry points: Menu **Stage**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Stage** and see tenant-scoped data
...
- Old URL: `production/stage/stage_controller/listall`
