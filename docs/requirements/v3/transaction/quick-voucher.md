...
- Entry points: Menu **Quick Voucher**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Quick Voucher** and see tenant-scoped data
...
- Old URL: `transaction/Quick_voucher/listall`
