...
- Entry points: Menu **Purchase Register**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Purchase Register** and see tenant-scoped data
...
- Old URL: `transaction/purchase/listall/purchase`
