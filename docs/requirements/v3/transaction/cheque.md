...
- Entry points: Menu **Cheque**; deep links from related registers/dashboards where applicable
...
- Entities involved: Sale, SaleLine, Customer, Item, AccLedgerTrans, AccAgeing, ItemGodown
...
- Given a user with menu access, they can open **Cheque** and see tenant-scoped data
...
- Old URL: `transaction/chque/list_all`
