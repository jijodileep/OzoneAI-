...
- Entry points: Menu **Receipt List**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Receipt List** and see tenant-scoped data
...
- Old URL: `transaction//vouchers//list_all//receipt`
