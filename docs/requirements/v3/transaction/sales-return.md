...
- Entry points: Menu **Sales Return**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Sales Return** and see tenant-scoped data
...
- Old URL: `transaction/sales/listall/sales_return`
