...
- Entry points: Menu **Sales Bill**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Sales Bill** and see tenant-scoped data
...
- Old URL: `transaction/sales/sales/sales`
