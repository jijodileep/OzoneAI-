...
- Entry points: Menu **Debit Note**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Debit Note** and see tenant-scoped data
...
- Old URL: `transaction/Credit_Debit_Vouchers/list_all/debit_note`
