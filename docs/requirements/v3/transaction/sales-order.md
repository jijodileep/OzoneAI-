...
- Entry points: Menu **Sales Order**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Sales Order** and see tenant-scoped data
...
- Old URL: `transaction/sales/listall/estimate`
