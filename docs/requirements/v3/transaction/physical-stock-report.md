...
- Entry points: Menu **Physical Stock Report**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P1
- Wave: 2
- Menu ID: 440

## 2. Purpose
Transactional ERP screen under the Transactions module. Persist header/lines, enforce permissions, support print/export where applicable.
...
- Given a user with menu access, they can open **Physical Stock Report** and see tenant-scoped data
...
- Old URL: `reports/ItemTransaction/physical_stk_update`
