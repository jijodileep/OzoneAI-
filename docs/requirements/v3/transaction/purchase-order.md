...
- Entry points: Menu **Purchase Order**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Purchase Order** and see tenant-scoped data
...
- Old URL: `transaction/purchase/listall/order`
