...
- Entry points: Menu **Purchase Bill**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Purchase Bill** and see tenant-scoped data
...
- Old URL: `transaction/purchase/create/purchase`
