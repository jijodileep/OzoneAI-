...
- Entry points: Menu **Purchase Return**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P0
- Wave: 1
- Menu ID: 105

## 2. Purpose
Purchase document screen. Types include purchase invoice, purchase return, and purchase order. Stock increases on purchase, decreases on return; orders are non-stocking until received. Shared engine rules: [transaction/purchase.md](../transaction/purchase.md).
...
- Entities involved: Purchase, PurchaseLine, Supplier, Item, AccLedgerTrans, AccAgeing
...
- Given a user with menu access, they can open **Purchase Return** and see tenant-scoped data
...
- Old URL: `transaction/purchase/listall/purchase_return`
