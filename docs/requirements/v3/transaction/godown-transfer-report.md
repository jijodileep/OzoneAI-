...
- Entry points: Menu **Godown Transfer Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Godown Transfer Report** and see tenant-scoped data
...
- Old URL: `reports/ItemTransaction/godown_transfer`
