...
- Entry points: Menu **Contra**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Contra** and see tenant-scoped data
...
- Old URL: `transaction//vouchers//listall//contra`
