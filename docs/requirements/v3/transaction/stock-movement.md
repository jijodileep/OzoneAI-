...
- Entry points: Menu **Stock Movement**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Stock Movement** and see tenant-scoped data
...
- Old URL: `reports/ItemTransaction/item_movement`
