...
- Entry points: Menu **Payment List**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Payment List** and see tenant-scoped data
...
- Old URL: `transaction//vouchers//list_all//payment`
