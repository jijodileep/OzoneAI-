...
- Entry points: Menu **Sales Register**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Sales Register** and see tenant-scoped data
...
- Old URL: `transaction/sales/listall/sales`
