...
- Entry points: Menu **Receipt Vouchers**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Receipt Vouchers** and see tenant-scoped data
...
- Old URL: `transaction//vouchers//listall//receipt`
