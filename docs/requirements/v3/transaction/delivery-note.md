...
- Entry points: Menu **Delivery Note**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P0
- Wave: 1
- Menu ID: 361

## 2. Purpose
Sales document screen (invoice, return, estimate/order, delivery note, or quotation). Stock and ledger effects depend on document type. Shared engine rules: [transaction/sales.md](../transaction/sales.md) and [transaction/quotation.md](../transaction/quotation.md).
...
- Given a user with menu access, they can open **Delivery Note** and see tenant-scoped data
...
- Old URL: `transaction/sales/listall/delivery_note`
