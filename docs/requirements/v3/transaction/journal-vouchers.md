...
- Entry points: Menu **Journal Vouchers**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Journal Vouchers** and see tenant-scoped data
...
- Old URL: `transaction//vouchers//listall//journal`
