...
- Entry points: Menu **Multi Unit Stock**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Multi Unit Stock** and see tenant-scoped data
...
- Old URL: `reports/items/unit_stock`
