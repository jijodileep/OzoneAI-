...
- Entry points: Menu **Material Type**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Material Type** and see tenant-scoped data
...
- Old URL: `master/amaster/material_type`
