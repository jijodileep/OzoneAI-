...
- Entry points: Menu **Company Info**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Company Info** and see tenant-scoped data
...
- Old URL: `company/com_info/listall`
