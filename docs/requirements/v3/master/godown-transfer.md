...
- Entry points: Menu **Godown Transfer**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Godown Transfer** and see tenant-scoped data
...
- Old URL: `master/itemtransfer/list_all`
