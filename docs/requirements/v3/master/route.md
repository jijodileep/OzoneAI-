...
- Entry points: Menu **Route**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Route** and see tenant-scoped data
...
- Old URL: `master/newmasters/route`
