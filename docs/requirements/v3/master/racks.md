...
- Entry points: Menu **Racks**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Racks** and see tenant-scoped data
