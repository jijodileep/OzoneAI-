...
- Entry points: Menu **Leads Master**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Leads Master** and see tenant-scoped data
...
- Old URL: `crm_general/Leads_master/listall`
