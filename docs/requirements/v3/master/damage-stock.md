...
- Entry points: Menu **Damage Stock**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Damage Stock** and see tenant-scoped data
...
- Old URL: `master/Itemdamage/list_all`
