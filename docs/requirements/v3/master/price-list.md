...
- Entry points: Menu **Price List**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Price List** and see tenant-scoped data
...
- Old URL: `pricelist/Pricelist/listall`
