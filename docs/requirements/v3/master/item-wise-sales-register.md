...
- Entry points: Menu **Item Wise Sales Register**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Item Wise Sales Register** and see tenant-scoped data
...
- Old URL: `reports/item/itemereport`
