...
- Entry points: Menu **Detailed stock report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Detailed stock report** and see tenant-scoped data
...
- Old URL: `reports/items/list_all`
