...
- Entry points: Menu **Vehicle**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Vehicle** and see tenant-scoped data
...
- Old URL: `master/Newmasters/ims_vehicle`
