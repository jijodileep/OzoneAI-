...
- Entry points: Menu **Item List Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Item List Report** and see tenant-scoped data
...
- Old URL: `reports/item/list_item`
