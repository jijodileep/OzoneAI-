...
- Entry points: Menu **Item Discount Group**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Item Discount Group** and see tenant-scoped data
