...
- Entry points: Menu **Replacement voucher**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Replacement voucher** and see tenant-scoped data
