...
- Entry points: Menu **Districts**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Districts** and see tenant-scoped data
...
- Old URL: `master/Newmasters/district`
