...
- Entry points: Menu **Bill Types**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Bill Types** and see tenant-scoped data
...
- Old URL: `master/Newmasters/bill_type`
