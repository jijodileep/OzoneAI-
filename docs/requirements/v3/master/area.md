...
- Entry points: Menu **Area**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Area** and see tenant-scoped data
...
- Old URL: `master/Newmasters/Area`
