...
- Entry points: Menu **Category**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Category** and see tenant-scoped data
