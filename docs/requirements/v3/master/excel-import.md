...
- Entry points: Menu **Excel Import**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Excel Import** and see tenant-scoped data
