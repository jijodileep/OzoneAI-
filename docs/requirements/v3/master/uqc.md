...
- Entry points: Menu **UQC**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **UQC** and see tenant-scoped data
