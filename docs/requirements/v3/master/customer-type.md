...
- Entry points: Menu **Customer Type**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Customer Type** and see tenant-scoped data
...
- Old URL: `master/Newmasters/customer_type`
