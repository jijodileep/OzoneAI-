...
- Entry points: Menu **Change Item Tax**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Change Item Tax** and see tenant-scoped data
...
- Old URL: `inventory_master/Item/change_item_tax`
