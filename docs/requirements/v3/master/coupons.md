...
- Entry points: Menu **Coupons**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Coupons** and see tenant-scoped data
...
- Old URL: `master/coupons/listall`
