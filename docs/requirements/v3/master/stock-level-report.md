...
- Entry points: Menu **Stock Level Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Stock Level Report** and see tenant-scoped data
...
- Old URL: `reports/Item/stocklevel`
