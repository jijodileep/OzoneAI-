...
- Entry points: Menu **Users**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Users** and see tenant-scoped data
...
- Old URL: `settings/NewMaster/Users`
