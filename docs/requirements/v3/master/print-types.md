...
- Entry points: Menu **Print Types**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Print Types** and see tenant-scoped data
...
- Old URL: `master/Newmasters/print_type`
