# Item Wise Order Register

## 1. Identity
- Module / area: master
- Page type: Report
- Primary users / roles: Authenticated tenant users with menu grant; Admin/Super Admin unrestricted for administration screens
- Entry points: Menu **Item Wise Order Register**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P1
- Wave: 2
- Menu ID: 392

## 2. Purpose
Master data maintenance screen (items, godowns, categories, areas, routes, coupons, stock tools, etc.). Typically CRUD with DataTables list + create/edit form (or Grocery CRUD). Changes here feed lookups used by sales/purchase/stock. Related: [master/item-master.md](../master/item-master.md).
...
- Entities involved: Item (or specific master entity), lookup tables, optional ItemGodown
...
- Given a user with menu access, they can open **Item Wise Order Register** and see tenant-scoped data
...
- Old URL: `reports/item/itemereport/estimate`
