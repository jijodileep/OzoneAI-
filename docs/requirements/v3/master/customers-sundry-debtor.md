...
- Entry points: Menu **Customers (Sundry Debtor)**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Customers (Sundry Debtor)** and see tenant-scoped data
