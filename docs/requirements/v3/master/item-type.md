...
- Entry points: Menu **Item Type**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Item Type** and see tenant-scoped data
