...
- Entry points: Menu **Type of Bussiness**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Type of Bussiness** and see tenant-scoped data
...
- Old URL: `crm_general/Leads_master/listTypeofBuss`
