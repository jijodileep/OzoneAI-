...
- Entry points: Menu **Set Database**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Set Database** and see tenant-scoped data
...
- Old URL: `master/Newmasters/year_database`
