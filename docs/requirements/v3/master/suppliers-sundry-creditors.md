...
- Entry points: Menu **Suppliers (Sundry Creditors)**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Suppliers (Sundry Creditors)** and see tenant-scoped data
