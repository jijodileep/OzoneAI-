...
- Entry points: Menu **Currency**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Currency** and see tenant-scoped data
...
- Old URL: `master/amaster/currency_type`
