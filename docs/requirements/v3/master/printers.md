...
- Entry points: Menu **Printers**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Printers** and see tenant-scoped data
...
- Old URL: `master/amaster/printers`
