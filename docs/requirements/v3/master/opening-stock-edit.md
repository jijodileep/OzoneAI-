...
- Entry points: Menu **Opening Stock Edit**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Opening Stock Edit** and see tenant-scoped data
