...
- Entry points: Menu **Stock Journal**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Stock Journal** and see tenant-scoped data
