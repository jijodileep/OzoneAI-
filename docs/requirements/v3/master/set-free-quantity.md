...
- Entry points: Menu **Set Free Quantity**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Set Free Quantity** and see tenant-scoped data
