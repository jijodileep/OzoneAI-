...
- Entry points: Menu **Modify Item Rates**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Modify Item Rates** and see tenant-scoped data
