...
- Entry points: Menu **Basic Units**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Basic Units** and see tenant-scoped data
