# Item Wise PR Register

## 1. Identity
- Module / area: master
- Page type: Report
- Primary users / roles: Authenticated tenant users with menu grant; Admin/Super Admin unrestricted for administration screens
- Entry points: Menu **Item Wise PR Register**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Item Wise PR Register** and see tenant-scoped data
...
- Old URL: `reports/item/pitemereport/purchase_return`
