...
- Entry points: Menu **Order Items Total**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Order Items Total** and see tenant-scoped data
...
- Old URL: `reports/items/order_items`
