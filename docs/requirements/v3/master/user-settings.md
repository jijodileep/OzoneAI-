...
- Entry points: Menu **User Settings**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **User Settings** and see tenant-scoped data
...
- Old URL: `settings/NewMaster/user_settings`
