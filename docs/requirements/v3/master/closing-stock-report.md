...
- Entry points: Menu **Closing Stock Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Closing Stock Report** and see tenant-scoped data
...
- Old URL: `reports/items/fifo_lifo`
