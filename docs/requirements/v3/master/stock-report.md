...
- Entry points: Menu **Stock Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Stock Report** and see tenant-scoped data
