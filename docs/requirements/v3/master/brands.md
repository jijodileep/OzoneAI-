...
- Entry points: Menu **Brands**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Brands** and see tenant-scoped data
...
- Old URL: `master/amaster/brands_master`
