...
- Entry points: Menu **Physical Stock Update**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Physical Stock Update** and see tenant-scoped data
