...
- Entry points: Menu **Leave Type**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Leave Type** and see tenant-scoped data
...
- Old URL: `master/Newmasters/hr_leavetype`
