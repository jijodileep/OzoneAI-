...
## 1. Identity
- Module / area: dashboard
- Page type: Dashboard
- Primary users / roles: Authenticated tenant users with menu grant; Admin/Super Admin unrestricted for administration screens
- Entry points: Menu **Admin Dashboard**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P0
- Wave: 1
- Menu ID: 491

## 2. Purpose
Operational dashboard / KPI landing page.
...
- Given a user with menu access, they can open **Admin Dashboard** and see tenant-scoped data
