...
- Entry points: Menu **Check List**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Check List** and see tenant-scoped data
...
- Old URL: `reports/accounts/checklist`
