...
- Entry points: Menu **Ledger Book**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Ledger Book** and see tenant-scoped data
...
- Old URL: `reports/accounts/leadger`
