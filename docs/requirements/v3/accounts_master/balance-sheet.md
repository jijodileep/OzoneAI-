...
- Entry points: Menu **Balance Sheet**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Balance Sheet** and see tenant-scoped data
...
- Old URL: `reports/accounts/balancesheet`
