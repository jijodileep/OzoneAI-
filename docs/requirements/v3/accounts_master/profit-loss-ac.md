...
## 1. Identity
- Module / area: accounts_master
- Page type: Report
- Primary users / roles: Authenticated tenant users with menu grant; Admin/Super Admin unrestricted for administration screens
- Entry points: Menu **Profit & Loss A/C**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P1
- Wave: 2
- Menu ID: 199

## 2. Purpose
Chart of accounts / ledger master. Hierarchy: Account Type → Sub Type → Main Ledger → Ledger; opening balance and Dr/Cr type drive all financial reports. System ledgers linked to customers/suppliers must be protected.
...
- Entities involved: AccType, AccSubType, AccMain, AccLedger, FinYear
...
- Given a user with menu access, they can open **Profit & Loss A/C** and see tenant-scoped data
...
- Old URL: `reports/accounts/profitandlossdaywise`
