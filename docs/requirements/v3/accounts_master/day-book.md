...
- Entry points: Menu **Day Book**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Day Book** and see tenant-scoped data
...
- Old URL: `reports/accounts/daybook`
