...
- Entry points: Menu **Sub Account**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Sub Account** and see tenant-scoped data
