...
- Entry points: Menu **Main Account**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Main Account** and see tenant-scoped data
