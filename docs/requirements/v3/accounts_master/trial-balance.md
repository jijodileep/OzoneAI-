...
- Entry points: Menu **Trial Balance**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Trial Balance** and see tenant-scoped data
...
- Old URL: `reports/accounts/trial`
