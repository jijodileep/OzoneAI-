...
- Entry points: Menu **Ledger Group report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Ledger Group report** and see tenant-scoped data
...
- Old URL: `reports/accounts/mainLeadger`
