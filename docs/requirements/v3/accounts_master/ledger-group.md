...
- Entry points: Menu **Ledger Group**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Ledger Group** and see tenant-scoped data
...
- Old URL: `accounts_master/LedgerGroup/listall`
