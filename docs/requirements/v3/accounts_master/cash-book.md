...
- Entry points: Menu **Cash Book**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Cash Book** and see tenant-scoped data
...
- Old URL: `reports/accounts/cashbook`
