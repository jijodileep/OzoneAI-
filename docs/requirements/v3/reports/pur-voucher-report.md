...
- Entry points: Menu **Pur Voucher Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Pur Voucher Report** and see tenant-scoped data
...
- Old URL: `reports/New_Purchase_report/listall`
