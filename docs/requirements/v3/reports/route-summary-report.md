...
- Entry points: Menu **Route Summary Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Route Summary Report** and see tenant-scoped data
...
- Old URL: `reports/sales/customersales`
