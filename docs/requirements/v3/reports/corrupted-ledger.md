...
- Entry points: Menu **Corrupted Ledger**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Corrupted Ledger** and see tenant-scoped data
...
- Old URL: `reports/Ledger_mistake/ledger_mistake`
