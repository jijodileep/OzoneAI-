...
- Entry points: Menu **Hsn Wise Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Hsn Wise Report** and see tenant-scoped data
