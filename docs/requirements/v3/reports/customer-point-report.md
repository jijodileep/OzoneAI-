...
- Entry points: Menu **Customer Point Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Customer Point Report** and see tenant-scoped data
...
- Old URL: `reports/Address_report/Reedeem`
