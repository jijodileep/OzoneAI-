...
- Entry points: Menu **Rec Voucher Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Rec Voucher Report** and see tenant-scoped data
...
- Old URL: `reports/New_voucher_receipt/listall`
