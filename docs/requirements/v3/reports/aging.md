...
- Entry points: Menu **Aging**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Aging** and see tenant-scoped data
