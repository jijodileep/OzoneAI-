# Landing Cost Margin Report

## 1. Identity
- Module / area: reports
- Page type: Report
- Primary users / roles: Authenticated tenant users with menu grant; Admin/Super Admin unrestricted for administration screens
- Entry points: Menu **Landing Cost Margin Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Landing Cost Margin Report** and see tenant-scoped data
...
- Old URL: `reports/Marginreport/landing_cost`
