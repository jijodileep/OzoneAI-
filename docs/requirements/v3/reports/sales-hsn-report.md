...
- Entry points: Menu **Sales HSN REPORT**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Sales HSN REPORT** and see tenant-scoped data
