...
- Entry points: Menu **Sales Summary Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Sales Summary Report** and see tenant-scoped data
...
- Old URL: `reports/Sales/sales_summary`
