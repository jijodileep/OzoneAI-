...
- Entry points: Menu **Item Wise Sales Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Item Wise Sales Report** and see tenant-scoped data
...
- Old URL: `reports/itemwisereport/sales`
