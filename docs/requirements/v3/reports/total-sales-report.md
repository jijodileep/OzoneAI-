...
- Entry points: Menu **Total Sales Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Total Sales Report** and see tenant-scoped data
...
- Old URL: `reports/totalinvoicereport/sales`
