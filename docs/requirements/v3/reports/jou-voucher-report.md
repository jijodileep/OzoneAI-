...
- Entry points: Menu **Jou Voucher Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Jou Voucher Report** and see tenant-scoped data
...
- Old URL: `reports/New_Voucher_Report/listall`
