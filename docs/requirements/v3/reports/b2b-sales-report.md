...
- Entry points: Menu **B2b Sales Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **B2b Sales Report** and see tenant-scoped data
