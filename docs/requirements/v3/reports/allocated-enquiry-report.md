# Allocated Enquiry Report

## 1. Identity
- Module / area: reports
- Page type: List
- Primary users / roles: Authenticated tenant users with menu grant; Admin/Super Admin unrestricted for administration screens
- Entry points: Menu **Allocated Enquiry Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Allocated Enquiry Report** and see tenant-scoped data
...
- Old URL: `crm_general/reports/Allocated_report/list_allocated_report`
