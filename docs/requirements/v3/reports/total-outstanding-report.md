...
- Entry points: Menu **Total Outstanding Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Total Outstanding Report** and see tenant-scoped data
...
- Old URL: `reports/outstandingreport/outstandingreport`
