...
- Entry points: Menu **Customer Ledger Balance**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Customer Ledger Balance** and see tenant-scoped data
...
- Old URL: `reports/Ledger_balance/ledger_balance/cus`
