...
- Entry points: Menu **Sales Order Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Sales Order Report** and see tenant-scoped data
...
- Old URL: `reports/Sales/saleorder`
