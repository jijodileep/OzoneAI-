...
- Entry points: Menu **Sale Voucher Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Sale Voucher Report** and see tenant-scoped data
...
- Old URL: `reports/New_Sales_report/listall`
