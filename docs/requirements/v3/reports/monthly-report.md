...
- Entry points: Menu **Monthly Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Monthly Report** and see tenant-scoped data
...
- Old URL: `reports/MIS/Monthly_summary`
