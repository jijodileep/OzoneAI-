...
- Entry points: Menu **Daybook Custome**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Daybook Custome** and see tenant-scoped data
...
- Old URL: `reports/Daybook/daybook_custome`
