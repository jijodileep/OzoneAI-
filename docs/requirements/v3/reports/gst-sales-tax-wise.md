...
- Entry points: Menu **Gst sales tax wise**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Gst sales tax wise** and see tenant-scoped data
