...
- Entry points: Menu **Stock Ledger**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Stock Ledger** and see tenant-scoped data
