...
- Entry points: Menu **Sales Cash Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Sales Cash Report** and see tenant-scoped data
...
- Old URL: `reports/invoice/salescashreport`
