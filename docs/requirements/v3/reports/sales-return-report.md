...
- Entry points: Menu **Sales Return Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Sales Return Report** and see tenant-scoped data
...
- Old URL: `reports/Sales/salesreturn`
