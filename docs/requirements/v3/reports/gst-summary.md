...
- Entry points: Menu **GST SUMMARY**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **GST SUMMARY** and see tenant-scoped data
...
- Old URL: `reports/GstSummary/gstsummary`
