...
- Entry points: Menu **Lead report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Lead report** and see tenant-scoped data
...
- Old URL: `crm_general/reports/Lead_report/list_leads_report`
