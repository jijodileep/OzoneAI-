...
- Entry points: Menu **Vehicle Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Vehicle Report** and see tenant-scoped data
...
- Old URL: `veh_reports/Trip_reports/listall`
