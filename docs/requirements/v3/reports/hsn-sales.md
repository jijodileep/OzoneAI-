...
- Entry points: Menu **Hsn sales**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Hsn sales** and see tenant-scoped data
...
- Old URL: `reports/hsn/saleshsn_consolidate`
