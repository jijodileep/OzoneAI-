...
- Entry points: Menu **AVG Item Margin**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **AVG Item Margin** and see tenant-scoped data
...
- Old URL: `reports/marginreport/custom_report`
