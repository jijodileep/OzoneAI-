...
- Entry points: Menu **Cancelled**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Cancelled** and see tenant-scoped data
...
- Old URL: `reports/Sales/salesreport/cancelled`
