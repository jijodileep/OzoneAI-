...
- Entry points: Menu **Itemwise Order**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Itemwise Order** and see tenant-scoped data
...
- Old URL: `reports/itemwisereport/salesorder`
