# Followup history report

## 1. Identity
- Module / area: reports
- Page type: List
- Primary users / roles: Authenticated tenant users with menu grant; Admin/Super Admin unrestricted for administration screens
- Entry points: Menu **Followup history report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Followup history report** and see tenant-scoped data
...
- Old URL: `crm_general/reports/Followup_report/list_followup_report`
