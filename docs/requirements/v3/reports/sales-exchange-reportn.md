...
- Entry points: Menu **Sales Exchange Report\n**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Sales Exchange Report\n** and see tenant-scoped data
...
- Old URL: `reports/Salesreturn/Adjustment`
