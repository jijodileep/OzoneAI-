...
- Entry points: Menu **Cheque Collection Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Cheque Collection Report** and see tenant-scoped data
...
- Old URL: `reports/Cheque/Cheque_data`
