...
- Entry points: Menu **GSTR2 Export**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **GSTR2 Export** and see tenant-scoped data
...
- Old URL: `reports/GST1Report/list_purchase`
