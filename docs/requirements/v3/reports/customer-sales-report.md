...
- Entry points: Menu **Customer Sales Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Customer Sales Report** and see tenant-scoped data
...
- Old URL: `reports/invoice/customereisereport`
