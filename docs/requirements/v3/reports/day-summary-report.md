...
- Entry points: Menu **Day Summary Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Day Summary Report** and see tenant-scoped data
...
- Old URL: `reports/Daybook/Daybook`
