# Route Customer Bill Details

## 1. Identity
- Module / area: reports
- Page type: Report
- Primary users / roles: Authenticated tenant users with menu grant; Admin/Super Admin unrestricted for administration screens
- Entry points: Menu **Route Customer Bill Details**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Route Customer Bill Details** and see tenant-scoped data
...
- Old URL: `reports/area/Customerwise`
