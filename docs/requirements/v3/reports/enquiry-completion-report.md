# Enquiry completion report

## 1. Identity
- Module / area: reports
- Page type: List
- Primary users / roles: Authenticated tenant users with menu grant; Admin/Super Admin unrestricted for administration screens
- Entry points: Menu **Enquiry completion report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Enquiry completion report** and see tenant-scoped data
...
- Old URL: `crm_general/reports/Enquiry_completion_report/list_completion_report`
