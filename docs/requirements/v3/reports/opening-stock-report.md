...
- Entry points: Menu **Opening Stock Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Opening Stock Report** and see tenant-scoped data
...
- Old URL: `reports/itemdetails/listall`
