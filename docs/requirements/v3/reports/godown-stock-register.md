...
- Entry points: Menu **Godown Stock Register**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Godown Stock Register** and see tenant-scoped data
...
- Old URL: `reports/Stock/day_stock`
