...
- Entry points: Menu **GSTR 1**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **GSTR 1** and see tenant-scoped data
