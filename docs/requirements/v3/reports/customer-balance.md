...
- Entry points: Menu **Customer Balance**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Customer Balance** and see tenant-scoped data
...
- Old URL: `reports/Invoice/customercashreport`
