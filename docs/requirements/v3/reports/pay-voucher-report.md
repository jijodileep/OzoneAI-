...
- Entry points: Menu **Pay Voucher Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Pay Voucher Report** and see tenant-scoped data
...
- Old URL: `reports/New_voucher_payment/listall`
