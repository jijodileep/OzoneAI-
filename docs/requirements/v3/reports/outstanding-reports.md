...
- Entry points: Menu **Outstanding Reports**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Outstanding Reports** and see tenant-scoped data
...
- Old URL: `reports/aging/outstand`
