...
- Entry points: Menu **GSTR1 Export**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **GSTR1 Export** and see tenant-scoped data
...
- Old URL: `reports/GST1Report/list_sales`
