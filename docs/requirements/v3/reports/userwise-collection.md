...
- Entry points: Menu **UserWise Collection**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **UserWise Collection** and see tenant-scoped data
...
- Old URL: `reports/MIS/route_summary`
