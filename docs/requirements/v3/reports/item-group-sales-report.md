...
- Entry points: Menu **Item Group sales Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Item Group sales Report** and see tenant-scoped data
...
- Old URL: `reports/Brandreport/brand_category`
