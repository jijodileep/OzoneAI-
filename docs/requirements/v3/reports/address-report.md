...
- Entry points: Menu **Address report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Address report** and see tenant-scoped data
...
- Old URL: `reports/Address_report/index`
