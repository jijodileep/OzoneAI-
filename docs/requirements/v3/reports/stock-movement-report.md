...
- Entry points: Menu **Stock Movement Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Stock Movement Report** and see tenant-scoped data
...
- Old URL: `reports/itemwisereport/quantity`
