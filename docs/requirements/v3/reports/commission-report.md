...
- Entry points: Menu **Commission Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Commission Report** and see tenant-scoped data
...
- Old URL: `reports/Commission/Commision`
