...
- Entry points: Menu **Sales Order Pending**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Sales Order Pending** and see tenant-scoped data
...
- Old URL: `reports/Sales_order_pending/list`
