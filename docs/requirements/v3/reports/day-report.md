...
- Entry points: Menu **Day Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Day Report** and see tenant-scoped data
...
- Old URL: `reports/Daybook/Day_Report`
