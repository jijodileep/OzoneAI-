...
- Entry points: Menu **GST EXPORT**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **GST EXPORT** and see tenant-scoped data
...
- Old URL: `reports/GST1Report/list`
