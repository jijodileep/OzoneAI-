...
- Entry points: Menu **Sales Reports**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Sales Reports** and see tenant-scoped data
...
- Old URL: `reports/Sales/salesreport`
