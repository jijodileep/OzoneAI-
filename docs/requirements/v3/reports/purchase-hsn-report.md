...
- Entry points: Menu **Purchase Hsn Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Purchase Hsn Report** and see tenant-scoped data
...
- Old URL: `reports/hsn/purchasehsn`
