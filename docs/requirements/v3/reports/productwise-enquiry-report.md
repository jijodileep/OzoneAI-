# Productwise Enquiry report

## 1. Identity
- Module / area: reports
- Page type: List
- Primary users / roles: Authenticated tenant users with menu grant; Admin/Super Admin unrestricted for administration screens
- Entry points: Menu **Productwise Enquiry report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Productwise Enquiry report** and see tenant-scoped data
...
- Old URL: `crm_general/reports/Productwise_report/list_product_report`
