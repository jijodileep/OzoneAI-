...
- Entry points: Menu **E-way Bill Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **E-way Bill Report** and see tenant-scoped data
