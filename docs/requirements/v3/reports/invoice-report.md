...
- Entry points: Menu **Invoice Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Invoice Report** and see tenant-scoped data
...
- Old URL: `reports/invoice/invoicereport`
