...
- Entry points: Menu **Supplier Ledger Balance**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Supplier Ledger Balance** and see tenant-scoped data
...
- Old URL: `reports/Ledger_balance/ledger_balance/sup`
