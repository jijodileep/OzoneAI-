# Gst purchase tax wise

## 1. Identity
- Module / area: reports
- Page type: Report
- Primary users / roles: Authenticated tenant users with menu grant; Admin/Super Admin unrestricted for administration screens
- Entry points: Menu **Gst purchase tax wise**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Gst purchase tax wise** and see tenant-scoped data
...
- Old URL: `reports/hsn/Billwise_purchase`
