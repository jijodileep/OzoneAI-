...
- Entry points: Menu **P Order Pending**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **P Order Pending** and see tenant-scoped data
...
- Old URL: `reports/Purchase_order_pending/list`
