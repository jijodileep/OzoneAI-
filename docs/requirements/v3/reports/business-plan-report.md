...
- Entry points: Menu **Business plan report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Business plan report** and see tenant-scoped data
...
- Old URL: `crm_general/reports/Bussiness_plan_report/list_busiplan_report`
