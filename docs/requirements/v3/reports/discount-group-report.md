...
- Entry points: Menu **Discount Group  Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Discount Group  Report** and see tenant-scoped data
