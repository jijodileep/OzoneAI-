...
- Entry points: Menu **Enquiry report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Enquiry report** and see tenant-scoped data
...
- Old URL: `crm_general/reports/Enquiry_report/list_enquiry_report`
