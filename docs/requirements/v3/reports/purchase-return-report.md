...
- Entry points: Menu **Purchase Return Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Purchase Return Report** and see tenant-scoped data
...
- Old URL: `reports/purchase/purchasereturn`
