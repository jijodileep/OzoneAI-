...
- Entry points: Menu **Total Purchase Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Total Purchase Report** and see tenant-scoped data
...
- Old URL: `reports/totalinvoicereport/purchase`
