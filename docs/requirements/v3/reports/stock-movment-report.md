...
- Entry points: Menu **Stock Movment Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Stock Movment Report** and see tenant-scoped data
...
- Old URL: `reports/Stock_movement_report/list`
