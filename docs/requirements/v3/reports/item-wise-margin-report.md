...
- Entry points: Menu **Item Wise Margin Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Item Wise Margin Report** and see tenant-scoped data
...
- Old URL: `reports/marginreport/itemwise`
