...
- Entry points: Menu **GSTR 2 Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **GSTR 2 Report** and see tenant-scoped data
...
- Old URL: `reports/gst/gstr2report`
