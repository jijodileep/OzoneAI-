...
- Entry points: Menu **SalesMan performance**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **SalesMan performance** and see tenant-scoped data
...
- Old URL: `reports/MIS/agent_summary`
