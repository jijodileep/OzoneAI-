...
- Entry points: Menu **Brand Sales Analysis**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Brand Sales Analysis** and see tenant-scoped data
...
- Old URL: `reports/Brandreport/brand_sales`
