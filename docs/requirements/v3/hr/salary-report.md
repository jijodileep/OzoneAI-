...
- Entry points: Menu **Salary Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Salary Report** and see tenant-scoped data
...
- Old URL: `hr/SalaryReport/salary_report`
