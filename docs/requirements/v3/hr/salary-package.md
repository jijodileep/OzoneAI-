...
- Entry points: Menu **Salary Package**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Salary Package** and see tenant-scoped data
...
- Old URL: `hr/SalaryPackage/list_all`
