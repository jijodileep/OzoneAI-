...
- Entry points: Menu **Holidays**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Holidays** and see tenant-scoped data
