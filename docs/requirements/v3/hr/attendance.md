...
- Entry points: Menu **Attendance**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Attendance** and see tenant-scoped data
...
- Old URL: `hr/Attendance/list_all`
