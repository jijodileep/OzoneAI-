...
- Entry points: Menu **Department**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Department** and see tenant-scoped data
...
- Old URL: `hr/department/list_all`
