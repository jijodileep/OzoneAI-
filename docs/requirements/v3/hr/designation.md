...
- Entry points: Menu **Designation**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Designation** and see tenant-scoped data
...
- Old URL: `hr/designation/list_all`
