...
- Entry points: Menu **Role**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Role** and see tenant-scoped data
