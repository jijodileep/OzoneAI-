...
- Entry points: Menu **Employee Report**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Employee Report** and see tenant-scoped data
...
- Old URL: `hr/EmployeeReport/list_all`
