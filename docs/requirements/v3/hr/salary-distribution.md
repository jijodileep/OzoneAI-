...
- Entry points: Menu **Salary Distribution**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P1
- Wave: 2
- Menu ID: 305

## 2. Purpose
HR module screen (employees, attendance, leave, salary packages, payroll distribution, masters). Employee links to salary components and may generate payslip PDFs. Payroll payments may integrate with vouchers/ledgers.
...
- Entities involved: HrProfile, Department, Designation, Leave, SalaryPackage, SalaryDistribution
...
- Given a user with menu access, they can open **Salary Distribution** and see tenant-scoped data
...
- Old URL: `hr/SalaryDistribution/list_all`
