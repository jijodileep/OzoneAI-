...
- Entry points: Menu **Course**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Course** and see tenant-scoped data
