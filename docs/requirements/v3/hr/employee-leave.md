...
- Entry points: Menu **Employee Leave**; deep links from related registers/dashboards where applicable
...
- Given a user with menu access, they can open **Employee Leave** and see tenant-scoped data
...
- Old URL: `hr/EmployeeLeave/list_all`
