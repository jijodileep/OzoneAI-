...
- Entry points: Menu **Cost Center**; deep links from related registers/dashboards where applicable
- Priority for rebuild: P1
- Wave: 2
- Menu ID: 344

## 2. Purpose
Analytics screen highlighting top/non-selling items or cost-centre analytics. Read-only; driven from sales_items/item history.
...
- Entities involved: Item, SaleLine aggregates
...
- Given a user with menu access, they can open **Cost Center** and see tenant-scoped data
...
- Old URL: `cost_analytics/Cost_centre/listall`
